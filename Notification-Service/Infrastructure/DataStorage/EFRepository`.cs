...
{
    public abstract class EFRepository<TAggregateRoot, TDbContext> : Repository<TAggregateRoot> where TAggregateRoot : class, 
        IAggregateRoot where TDbContext : DbContext, IUnitOfWork
    {
